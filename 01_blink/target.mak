...
LDFLAGS += -Wl,-T,$(SELF_DIR)/01_blink/lib/CMSIS/DeviceSupport/ST/STM32F4xx/startup/stm32f4xx_flash.ld,-Map,$(SELF_DIR)/01_blink/$(TARGET).map -Wl,--gc-sections

# Additional include paths to consider
INCLUDES = $(SELF_DIR)/01_blink \
			$(SELF_DIR)/01_blink/lib/CMSIS/CoreSupport \
			$(SELF_DIR)/01_blink/lib/CMSIS/DeviceSupport/ST/STM32F4xx \
			$(SELF_DIR)/01_blink/lib/STM32F4xx_StdPeriph_Driver/inc
