...
int main()
{
	...
	//RCC_Clocks.HCLK_Frequency contains the amount of ticks of the counter per second
	//divided by 1000 we get the amount of ticks per millisecond
	SysTick_Config(RCC_Clocks.HCLK_Frequency / 1000);

	//Configure the interrupt controller to have 16 different priorities and no subpriorities
